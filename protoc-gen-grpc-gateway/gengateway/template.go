...
// Code generated by protoc-gen-auth-grpc-gateway. DO NOT EDIT.
// source: {{.GetName}}
...
import (
	...
	"github.com/infotech-group/grpc-gateway/protoc-gen-grpc-gateway/auth"
)
...
func Register{{$svc.GetName}}{{$.RegisterFuncSuffix}}FromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption, authHandler auth.AuthHandler) (err error) {
	...
	return Register{{$svc.GetName}}{{$.RegisterFuncSuffix}}(ctx, mux, conn, authHandler)
}

// Register{{$svc.GetName}}{{$.RegisterFuncSuffix}} registers the http handlers for service {{$svc.GetName}} to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func Register{{$svc.GetName}}{{$.RegisterFuncSuffix}}(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn, authHandler auth.AuthHandler) error {
	return Register{{$svc.GetName}}{{$.RegisterFuncSuffix}}Client(ctx, mux, New{{$svc.GetName}}Client(conn), authHandler)
}
...
func Register{{$svc.GetName}}{{$.RegisterFuncSuffix}}Client(ctx context.Context, mux *runtime.ServeMux, client {{$svc.GetName}}Client, authHandler auth.AuthHandler) error {
	{{range $m := $svc.Methods}}
	{{range $b := $m.Bindings}}
