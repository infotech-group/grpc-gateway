...
[![CircleCI](https://circleci.com/gh/infotech-group/grpc-gateway.svg?style=svg)](https://circleci.com/gh/infotech-group/grpc-gateway)
...
## Check out our [documentation](https://infotech-group.github.io/grpc-gateway/)!
...
```sh
go get -u github.com/infotech-group/grpc-gateway/protoc-gen-grpc-gateway
go get -u github.com/infotech-group/grpc-gateway/protoc-gen-swagger
...
2. Add a [`google.api.http`](https://github.com/googleapis/googleapis/blob/master/google/api/http.proto#L46) to your .proto file
   ...
   If you do not want to modify the proto file for use with grpc-gateway you can alternatively use an external [gRPC Service Configuration](https://cloud.google.com/endpoints/docs/grpc/grpc-service-config) file. [Check our documentation](https://infotech-group.github.io/grpc-gateway/docs/grpcapiconfiguration.html) for more information.
...
* [How gRPC error codes map to HTTP status codes in the response](https://github.com/infotech-group/grpc-gateway/blob/master/runtime/errors.go#L15)
